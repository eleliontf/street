  ...
  _createClass(ActiveMenu, [{
    ...
    value: function addActive(navbarParam) {
      ...
      location.pathname[location.pathname.length - 1] == '/' ? navbarParam[0].classList.add(this.activeClass) : navbarParam.forEach(function (e) {
        if (e.attributes[1].value.includes('https://www.indonez.com/html-demo/') && e.attributes[1].value.slice(3) == _this.path) e.classList.add(_this.activeClass);
...
var Blog = /*#__PURE__*/function () {
  ...
  _createClass(Blog, [{
    ...
    value: function getData() {
      return Promise.all([fetch('blog/data/data-blog.json'), fetch('blog/data/data-category.json'), fetch('blog/data/data-tag.json')]);
    }
  }, {
    key: "contentTruncate",
    ...
    value: function createCategoryWidget(data) {
      ...
      if (document.querySelector('.widget-categories') !== null) {
        ...
        categoryFilter.forEach(function (eachData) {
          _this3.categoryWrap.innerHTML += "<li><a href=\"blog-find.html?category=".concat(eachData.category.toLowerCase(), "\" class=\"link-dark text-decoration-none\">").concat(eachData.category, "<span class=\"badge float-end\">").concat(eachData.totalPost, "</span></a></li>");
        });
      }
    }
  }, {
    ...
    value: function createTagWidget(data) {
      ...
      if (document.querySelector('.widget-tag') !== null) {
        ...
        tagFilter.forEach(function (eachTag) {
          if (eachTag.length !== 0) {
            _this5.tagWrap.innerHTML += "<a href=\"blog-find.html?tag=".concat(eachTag, "\"><span class=\"badge\">#").concat(eachTag, "</span></a>");
          } else {
    ...
    value: function createPagination(data) {
      if (document.querySelector('[data-title="blog"]')) {
        ...
        var page = !this.currentPage.includes('blog-page') ? 1 : parseInt(this.currentPage.substring(10).slice(0, -5));
        var liTag = '';
        var active = '';
        ...
        for (var plength = beforePage; plength <= afterPage; plength++) {
          ...
          liTag += "<li class=\"page-item ".concat(active, "\"><a class=\"page-link\" href=\"").concat(plength == 1 ? data[0].asBlog : "blog-page-".concat(plength, ".html"), "\">").concat(plength, "</a></li>");
        } // show the next button if the page value is less than totalPage(20)


        if (page < totalPages - 1) {
          liTag += "<li class=\"page-item\"><a class=\"page-link\" href=\"blog-page-".concat(totalPages, ".html\" aria-label=\"next\"><span aria-hidden=\"true\">&raquo;</span></a></li>");
      ...
      if (document.forms['blog-search'] !== undefined) {
        ...
        inputSearch.addEventListener('submit', function (e) {
          ...
          if (!inputSearch.checkValidity()) {
            ...
            location.href = "blog-find.html?".concat(params.toString());
          }
        });
    ...
    value: function postFormat(_ref2) {
      ...
      return "\n    <article class=\"card mb-4\">\n        <div class=\"card-body blog-card p-3 p-md-4\">\n            <h3 class=\"fw-bold\">\n                <a href=\"/blog/".concat(link, "\" class=\"link-primary text-decoration-none\">").concat(title, "</a>\n            </h3>\n            <p>").concat(content, "</p>\n            <div class=\"blog-author d-flex align-items-center\">\n                <img class=\"rounded-circle me-1\" src=\"https://www.indonez.com/html-demo/").concat(author.avatar, "\" alt=\"author\" width=\"32\" height=\"32\">\n                <small class=\"text-muted\">\n                    ").concat(author.name, "<span class=\"mx-1\">\u2022</span>").concat(date, "\n                </small>\n            </div>\n        </div>\n        <div class=\"card-footer blog-footer d-flex justify-content-between align-items-center px-3 px-md-4 py-2\">\n            <span class=\"badge bg-secondary\">").concat(category, "</span>\n            <a href=\"").concat(link, "\" class=\"btn btn-link\"><i class=\"fas fa-arrow-right\"></i>Read more</a>\n        </div>\n    </article>\n    ");
    }
  }, {
    key: "checkDiff",
